...
const closeRateGameWindow = () => {
    isRateGameMobileWindowOpen.value = false
}

const handleRateGameWindow = (e) => {
    if (!rateGameContainerRef.value && !rateGameWrapperRef.value) return

    const target = e.target
    if (!isDesktopView.value && !rateGameWrapperRef.value.contains(target)) {
        isRateGameMobileWindowOpen.value = false
    }
}
</script>
...
<template>
    <div class="rate-game-container" @click="handleRateGameWindow" ref="rateGameContainerRef">
        <div class="rate-game-wrapper" ref="rateGameWrapperRef">
            <div class="rate-game">
